    ...
    return (
      <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <Link href="/auth/signin" className="text-brand-400 hover:text-brand-300 text-sm font-medium">
            Back to sign in
          </Link>
        </div>
      </main>
    ...
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">No problem. We&apos;ll send you a reset link.</p>
        </div>
        ...
        <p className="text-center mt-6">
          <Link href="/auth/signin" className="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-zinc-300 transition-colors">
            <ArrowLeft size={14} />
            Back to sign in
          </Link>
        </p>
