...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://selfemployedfyi.com/field/how-to-build-business-credit" },
};
  ...
  return (
    <ArticleLayout article={article}>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 my-2 space-y-2 text-sm text-slate-400">
        <div className="flex items-start gap-2"><span className="text-emerald-400 shrink-0">1</span>Form an LLC or corporation (sole proprietors can build some business credit but have limits)</div>
        <div className="flex items-start gap-2"><span className="text-emerald-400 shrink-0">2</span>Get an EIN from irs.gov (free, takes 10 minutes)</div>
        <div className="flex items-start gap-2"><span className="text-emerald-400 shrink-0">3</span>Open a dedicated business bank account in the business's name</div>
        <div className="flex items-start gap-2"><span className="text-emerald-400 shrink-0">4</span>Get a business phone number (even a Google Voice number) listed publicly</div>
        <div className="flex items-start gap-2"><span className="text-emerald-400 shrink-0">5</span>Get a DUNS number from Dun and Bradstreet (free at dnb.com/duns-number)</div>
      </div>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 my-2 space-y-3 text-sm">
        <div>
          <p className="font-semibold text-white">Secured business credit card</p>
          <p className="text-slate-400 mt-0.5">You put down a deposit that becomes your credit limit. Builds credit with use. Good starting point if you have limited personal credit too.</p>
        </div>
        <div>
          <p className="font-semibold text-white">Credit union business cards</p>
          <p className="text-slate-400 mt-0.5">Local credit unions often have more flexible underwriting for small business cards. Worth checking with whichever credit union you bank with.</p>
        </div>
        <div>
          <p className="font-semibold text-white">Brex or Ramp (charge cards)</p>
          <p className="text-slate-400 mt-0.5">These underwrite based on business bank account balance, not personal credit. Good if you have revenue but limited credit history. No personal guarantee at standard tiers.</p>
        </div>
      </div>
