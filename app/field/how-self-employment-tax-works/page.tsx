...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://selfemployedfyi.com/field/how-self-employment-tax-works" },
};
  ...
  return (
    <ArticleLayout article={article}>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 my-2 space-y-2">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-slate-300">Medicare</span>
        ...
        <div className="flex justify-between text-sm font-semibold border-t border-slate-700 pt-2 mt-2">
          ...
          <span className="font-mono text-emerald-300">15.3%</span>
        </div>
      </div>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 my-2 space-y-2 font-mono text-sm">
        <div className="flex justify-between">
          <span className="text-slate-400">Net SE income</span>
          <span className="text-white">$100,000</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">x 92.35%</span>
          <span className="text-white">$92,350</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">x 15.3% SE tax rate</span>
        ...
        <div className="flex justify-between font-semibold border-t border-slate-700 pt-2 mt-2">
          <span className="text-slate-200">SE tax owed</span>
          <span className="text-emerald-300">$14,130</span>
        </div>
      </div>
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 my-2 space-y-2 font-mono text-sm">
        <div className="flex justify-between"><span className="text-slate-400">Net SE income</span><span className="text-white">$100,000</span></div>
        <div className="flex justify-between"><span className="text-slate-400">SE tax</span><span className="text-white">($14,130)</span></div>
        <div className="flex justify-between"><span className="text-slate-400">Deductible SE (half)</span><span className="text-white">($7,065)</span></div>
        <div className="flex justify-between"><span className="text-slate-400">Adjusted gross income</span><span className="text-white">$92,935</span></div>
        <div className="flex justify-between"><span className="text-slate-400">Standard deduction</span><span className="text-white">($15,000)</span></div>
        <div className="flex justify-between"><span className="text-slate-400">Federal taxable income</span><span className="text-white">$77,935</span></div>
        <div className="flex justify-between"><span className="text-slate-400">Federal income tax</span><span className="text-white">($13,241)</span></div>
        <div className="flex justify-between font-semibold border-t border-slate-700 pt-2 mt-2">
          <span className="text-slate-200">Total federal tax</span>
      ...
      <div className="bg-emerald-950/40 border border-emerald-800/40 rounded-xl p-5 my-2">
        <p className="text-emerald-300 font-semibold text-sm mb-2">Run the numbers for your income</p>
